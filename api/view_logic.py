...
class QuestionAnswer:
    ...
    def get_all_questions():
        ...
        return jsonify({'Questions':[question.__dict__ for question in QuestionAnswer.questions]}), 200
    @staticmethod 
    def get_one_question(question_id):
        ...
        x = [question.__dict__ for question in QuestionAnswer.questions if question.__dict__['user_question_id'] == question_id]
        if len(x) == 0:
            return jsonify({question_id:"Question id doesnot exist"}), 200            
        return jsonify({'requested question': [question.__dict__ for question in QuestionAnswer.questions if question.__dict__['user_question_id'] == question_id]}), 200
    @staticmethod 
    def post_a_quetion():
        """
        ...
        x = [question.__dict__ for question in QuestionAnswer.questions if question.__dict__['user_question_id'] == request.json['user_question_id']]
        if len(x) != 0:
        ...
        return jsonify({'New question file': [x.__dict__ for x in QuestionAnswer.questions]}), 201
    ...
    def post_an_answer(question_id):
        ...
        h = [answer.__dict__ for answer in QuestionAnswer.answers if answer.__dict__['answer_id'] == request.json['answer_id']]
        if len(h) != 0:
        ...
        return jsonify({'Question':[question.__dict__ for question in QuestionAnswer.questions if question.__dict__['user_question_id'] == question_id]}, {'Answer to question': [x.__dict__ for x in QuestionAnswer.answers if x.__dict__['user_question_id'] == question_id]}), 201
